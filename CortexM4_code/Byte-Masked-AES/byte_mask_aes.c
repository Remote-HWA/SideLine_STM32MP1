...
void calcSbox_masked(){
    ...
    for(cnt=0;cnt<256;cnt++){
    	//Sbox_masked[cnt^0] = sbox[cnt]^0; //mask 0
    	//Sbox_masked[cnt^0] = sbox[cnt]^0xAA; //mask 0xAA
...
void init_masked_round_keys(){
    ...
    int i;
	for(i = 0; i<10;i++){
		//remask(RoundKey_masked[i],0,0,0,0,0,0,0,0); //mask 0
		remask(RoundKey_masked[i],Mask[6],Mask[7],Mask[8],Mask[9],Mask[4],Mask[4],Mask[4],Mask[4]);
	}
	
	//1st RK Mask m' to 0
	//remask(RoundKey_masked[10],0,0,0,0,0,0,0,0); //mask 0
	//remask(RoundKey_masked[10],0,0,0,0,0xAA,0xAA,0xAA,0xAA); // mask 0xAA
...
{	
	...
	//remask(state,0,0,0,0,0,0,0,0); //mask 0
