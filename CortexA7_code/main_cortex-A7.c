			...
			for(int i = 0 ; i < nbSamplesInput ; i++)
			{
				switch(UNIT_VAL)
				{
					case 119:
						...
						if(((lngArray[i+1]>>16)&0xFFF)==0xcce || ((lngArray[i+1]>>16)&0xFFF)==0x0ce)
						{
							printf(",");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0xcc6)
						{
							printf("-");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0xcee)
						{
							printf(".");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0xce6)
						{
							printf("/");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0xc4e)
						{
							printf("0");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0xc46)
						{
							printf("1");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0xc6e)
						{
							printf("2");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0xc66)
						{
							printf("3");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x4ce)
						{
							printf("4");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x4c6)
						{
							printf("5");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x4ee)
						{
							printf("6");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x4e6)
						{
							printf("7");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x44e)
						{
							printf("8");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x446)
						{
							printf("9");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x46e)
						{
							printf(":");
						}
						else if(((lngArray[i+1]>>16)&0xFFF)==0x466)
						{
							printf(";");
						}
						else
						{
						printf(" %03x ",((unsigned int)lngArray[i+1]>>16)&0xfff);
						}
						break;
					default:
						printf(" %03x ",((unsigned int)lngArray[i+1]>>16)&0xfff);
